      ...
      <el-tabs value="skills" type="border-card">
        <el-tab-pane label="基础信息">
          ...
          <el-form-item label="技能">
            <div>
              <a-rate v-model:value="model.scores.skills" :count="10"></a-rate>
              {{ model.scores.skills }}
            </div>
          </el-form-item>
          <el-form-item label="攻击">
            <div>
              <a-rate v-model:value="model.scores.attack" :count="10"></a-rate>
              {{ model.scores.attack }}
            </div>
          </el-form-item>
          <el-form-item label="生存">
            <div>
              <a-rate v-model:value="model.scores.survive" :count="10"></a-rate>
